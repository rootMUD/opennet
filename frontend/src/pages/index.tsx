...
export default function Home() {
	...
	// 	console.log(
	// 		'请求参数：' + `${args.hash}::${args.module}::${args.method}`
	// 	);
	...
	async function connect_contract() {
		...
		const f_payload = (await obelisk.tx.aggr.bind_user(
			[inputValue2, inputValue1], // params
	...
	return (
		<div>
			...
			<br></br>
			<button
				className="bg-blue hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"
				onClick={() => submitTransation()}
			>
				{' '}
				submit
			</button>
